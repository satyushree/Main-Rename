...
@RenamerNs.on_message(filters.private & filters.command("broadcast") & filters.user(Config.AUTH_USERS) & filters.reply)
...
@RenamerNs.on_callback_query(filters.create(lambda _, query: query.data.startswith('cbroadcast')) 
                                 & filters.user(Config.AUTH_USERS))
